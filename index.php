...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="omnifood, food, delivery, premium">
    ...
    <body>
        ...
        <section class="section-meals">
            <ul class="meals-showcase clearfix">
                ...
                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/4.jpg" alt="Autumn pupmkin soup"/>
                    </figure>
                </li>
            </ul>
            <ul class="meals-showcase clearfix">
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery her in Lisbon, but no one comes even close to Omnifood. Me and my family are so in love!
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        <div class="row">
                            <?php
                                if ($_GET['success'] == 1) {
                                    echo "<div class=\"form-messages success zoomIn\"> Thank you! Your message has been sent.</div>";
                                }
                                
                                if ($_GET['success'] == -1) {
                                    echo "<div class=\"form-messages error zoomIn\">Error! Something went wrong.</div>";
                                }
                            ?>
                        </div>
                        <div class="row">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-117980212-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-117980212-1');
        </script>
